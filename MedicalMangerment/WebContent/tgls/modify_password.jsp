			...
			<!-- <table style="">
				...
				<div class="inbox-page">
					...
					<div class="inbox-row widget-shadow" id="accordion" role="tablist" aria-multiselectable="true">
						...
						<a id="<s:property value="#news.eid"></s:property>" class="btn_down" role="button" data-toggle="collapse" data-parent="#accordion" href="#<s:property value="#news.eid"></s:property><s:property value="#news.eid"></s:property>" aria-expanded="true" aria-controls="collapseOne">
						...
						<div id="<s:property value="#news.eid"></s:property><s:property value="#news.eid"></s:property>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
							<div class="mail-body">
								<div></div>
								...
								<form action="${pageContext.request.contextPath}/notification_send?eid=<s:property value="#news.eid"></s:property>" method="post">
									<input type="submit"   class="send_btn" value="发送至药厂">
								</form>
							</div>
						</div>
					</div>		
				...
				<div class="inbox-page row">
					...
					<div class="inbox-row widget-shadow">
						...
						<a id="<s:property value="#Yesterday.eid"></s:property>" class="btn_down" role="button" data-toggle="collapse" data-parent="#accordion" href="#<s:property value="#Yesterday.eid"></s:property><s:property value="#Yesterday.eid"></s:property>" aria-expanded="true" aria-controls="collapseFive">
						...
						<div class="clearfix"> </div>
						<div id="<s:property value="#Yesterday.eid"></s:property><s:property value="#Yesterday.eid"></s:property>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
							<div class="mail-body">
								...
								<form action="${pageContext.request.contextPath}/notification_send?eid=<s:property value="#Yesterday.eid"></s:property>" method="post">
									<input type="submit"  class="send_btn" value="发送至药厂">
								</form>
							</div>
						</div>
				...
				<div class="inbox-page row">
					...
					<div class="inbox-row widget-shadow">
						...
						<a id="<s:property value="#old.eid"></s:property>" class="btn_down" role="button" data-toggle="collapse" data-parent="#accordion" href="#<s:property value="#old.eid"></s:property><s:property value="#old.eid"></s:property>" aria-expanded="true" aria-controls="collapse18">
						...
						<div class="clearfix"> </div>
						<div id="<s:property value="#old.eid"></s:property><s:property value="#old.eid"></s:property>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading18">
							<div class="mail-body">
								...
								<form action="${pageContext.request.contextPath}/notification_send?eid=<s:property value="#old.eid"></s:property>" method="post">
									<input type="submit"   class="send_btn" value="发送至药厂">
								</form>
							</div>
						</div>
