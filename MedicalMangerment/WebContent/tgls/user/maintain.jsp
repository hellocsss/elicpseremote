...
<html>
	...
	<head>
		...
		<style>
			body{
				...
				height: 100%;
				overflow: hidden;
				background: url(${pageContext.request.contextPath}/images/other/maintain_bottom.png) no-repeat center bottom;
			...
			.midd p{
				...
				font-size: 24px;
				color: #00bfb4;
				background: url(${pageContext.request.contextPath}/images/other/maintain_pic_bg.png) no-repeat center bottom;
	...
	<body>
		<div class="midd">
			<img src="${pageContext.request.contextPath}/images/other/maintain_pic.png" />
			<p>您暂无权限操作...</p>
		</div>
		<script>
			$(function(){
