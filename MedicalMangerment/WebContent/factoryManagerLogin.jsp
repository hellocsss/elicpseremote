...
<body class="login" mycollectionplug="bind" style="background:url(images/background.jpeg);background-repeat:no-repeat;background-size:cover">
<div class="login_m">
<div class="login_logo"><img src="./Wopop_files/logo2.png" width="400" height="69"></div>
<div class="login_boder">

<div class="login_padding" id="login_model">

<form action="login_factoryManager" method="post">
  <h2>用户名</h2>
  <label>
