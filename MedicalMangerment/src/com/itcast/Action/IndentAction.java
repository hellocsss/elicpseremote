...
public class IndentAction extends ActionSupport implements ModelDriven<Indent>{
	...
	//	Indent indent =new Indent();
		...
		for (ShopItem shopItem : shopItems) {
			...
			indentDetail.setCountes(shopItem.getCount());
			...
			indentDetail.setDate(indentDate);
	...
	public String findIndent(){
		PageBeanPublic pageBean=indentService.ListPage(currentPage);
	...
	public String SearchIndent() {
		...
		PageBeanPublic pageBean =indentService.SearchIndentPage(currentPage,user);
		ActionContext.getContext().getValueStack().set("pageBean", pageBean);
	...
	public String findIndentById() {
		User user = userService.finById(uid);
		//List<Indent> indentList =indentService.SearchIndent(uid);
		PageBeanPublic pageBean =indentService.SearchIndentPage(currentPage,user);
		ActionContext.getContext().getValueStack().set("pageBean", pageBean);
		return "searchSuccess";
